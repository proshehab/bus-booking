                    ...
                    <div class="col-xl-4 offset-xl-4 col-md-12 col-12">
                        <div class="text-center">
                            ...
                            <p class="mb-0">
                                ...
                                <a href="sign-up.html" class="text-primary">Register here</a>
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body p-6">
                                ...
                                <div class="mt-3 d-flex gap-2 justify-content-between">
                                    <a href="#" class="btn btn-google w-100">
                                        <span class="me-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="ti ti-google" viewBox="0 0 16 16">
                                                <path
                                    ...
                                    <a href="#" class="btn btn-facebook w-100">
                                        <span class="me-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="ti ti-facebook" viewBox="0 0 16 16">
                                                <path
